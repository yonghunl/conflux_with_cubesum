...
%     N_rep_adv = 50;
    ...
    for n_rep_each_adv_ratio = 1: N_rep_adv
        ...
        for n_blc = 1: N_total_blc % cubesum reaction time
            ...
            if n_blc >1
                if (new_blc.flag_cube == 1) && (prev_blc.flag_cube == 0) && (Time_M1_to_M2_cube == 0)
                    Time_M1_to_M2_cube = new_blc.time_stamp;
                end
                if (new_blc.flag_cube == 0) && (prev_blc.flag_cube == 1) && (Time_M2_to_M1_cube == 0)
        ...
        for n_blc = 1: N_total_blc % conflux reaction time
            ...
            if n_blc >1
                if (new_blc.flag_conflux == 1) && (prev_blc.flag_conflux == 0) &&(Time_M1_to_M2_conflux == 0)
                    Time_M1_to_M2_conflux = new_blc.time_stamp;
                end
                if (new_blc.flag_conflux == 0) && (prev_blc.flag_conflux == 1) && (Time_M2_to_M1_conflux == 0)
